...
Документ актуален для `WrtMonitor v0.12.0`.

## Аккаунт владельца

Страница `/account` содержит уведомления, активные Android/API refresh-сессии, смену пароля владельца, последние 100 записей аудита и PostgreSQL backup.
