...
Контейнер применяет текущую исходную схему PostgreSQL при старте. До публичной beta тестовую базу разрешено пересоздавать между несовместимыми версиями; PostgreSQL volume не удаляется автоматически.
