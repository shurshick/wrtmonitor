...
|---|:---:|:---:|:---:|:---:|---|---|---|---|
| `agent.bash_script` | да | искл. | да | да | `agent.bash_script` | level_3_reversible_config | handler_result | not_available |
...
| `agent.ssh_session` | да | искл. | да | да | `agent.ssh_session` | level_2_safe_action | handler_result | not_available |
...
| `wifi.set_access_profile` | да | да | да | да | `wifi.access_profile` | level_3_reversible_config | read_after_write_config | configuration_backup |
