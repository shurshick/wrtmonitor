...
Версия `0.3.0-rc6` сохраняет модульный layout и обновляется поверх предыдущих RC штатным update-механизмом.
...
wget -O wrtmonitor-agent.tar.gz \
  https://github.com/shurshick/wrtmonitor/releases/download/v0.3.0-rc6/wrtmonitor-openwrt-agent-v0.3.0-rc6.tar.gz
