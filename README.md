...
Текущая тестовая версия: `v0.33.0`. Публичного стабильного релиза пока нет; тестовые базы можно пересоздавать между несовместимыми версиями.
...
```text
wrtmonitor-truenas-v0.33.0.yaml
```
