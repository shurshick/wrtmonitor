...
Текущая тестовая версия: `v0.35.9`. Публичного стабильного релиза пока нет; тестовые базы можно пересоздавать между несовместимыми версиями.

Главное в `0.35.0` - `0.35.9`:
...
- внедрена криптографическая проверка подписей (RSA/Ed25519) при автоматических обновлениях агента.
