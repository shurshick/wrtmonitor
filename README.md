...
Текущий prerelease: `v0.2.0-rc2`.

Главное в `0.2.0-rc2`:

- Web UI с отдельными разделами обзора, интернета, домашней сети, Wi-Fi, системы и обслуживания;
...
- telemetry schema v2, клиенты, DHCP, Wi-Fi, сеть и системные команды из `rc1`;
- валидация, подтверждение, аудит и backup для изменений конфигурации.
