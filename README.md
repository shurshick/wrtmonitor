...
- добавлен API для мобильного приложения (`/api/v1/account`);
- реализована отправка Push-уведомлений через Firebase Cloud Messaging (FCM);
- добавлены Event Hooks для получения уведомлений об успешном входе и изменении статуса роутера;
