...
Текущая стабильная версия: `v0.13.5`.

Главное в `0.13.5`:

- на главную страницу проекта добавлены актуальные скриншоты Web UI;
- разделы firewall и зон свёрнуты по умолчанию;
- идентификация, службы и настройка времени открываются по нажатию и не перегружают страницу системы;
- browser E2E фиксирует закрытое состояние и раскрытие пользовательских секций.
