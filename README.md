...
- постоянный реестр клиентов с именами, производителем, статусом и историей трафика;
- блокировка интернета, расписания и приоритет для отдельных устройств;
- профили для групп клиентов в Web UI и Android;
- общая настройка SQM и передача RX/TX из `nlbwmon`;
- capability report schema v6 и PostgreSQL E2E нового реестра.
