...
Текущая тестовая версия: `0.52.1 Release Candidate`. Публичного стабильного релиза пока нет; тестовые базы можно пересоздавать между несовместимыми версиями.

Главное в `0.52.1`:

- исправлено определение доступных обновлений в OpenWrt с пакетным менеджером APK 3;
- Web UI получает реальные названия пакетов, текущие и доступные версии;
- сохранена совместимость со старым форматом APK и пакетным менеджером opkg;
- исправление проверено на Netis NX31 с OpenWrt 25.12.4.
