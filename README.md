...
Текущая стабильная версия: `v0.13.2`.

Главное в `0.13.2`:

- клиенты домашней сети отображаются компактным списком вместо крупных плиток;
- поиск и фильтры помогают быстро найти онлайн-, офлайн-устройство, IP или MAC;
- нажатие на строку открывает сведения, профиль доступа, расписание, блокировку и приоритет;
- одинаковая модель управления реализована в Web UI и Android.
