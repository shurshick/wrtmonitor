...
Текущая тестовая версия: `v0.24.1-ui-unification`. Публичного стабильного релиза пока нет; тестовые базы можно пересоздавать между несовместимыми версиями.

Главное в `0.24.1`:

- Web UI и Android получили отдельный сохраняемый переключатель светлой и тёмной темы;
- список служб в обслуживании ограничен по высоте и прокручивается внутри рабочего блока;
- карточки обслуживания выровнены в единую сетку;
- роутер можно безопасно отправить на перезагрузку прямо из списка устройств.
