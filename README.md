...
- несколько SSID на каждом радиомодуле, добавление, изменение и удаление сетей;
- настройка канала, ширины, региона и мощности передатчика;
- расписание работы Wi-Fi, изоляция клиентов, 802.11r/k/v и Mesh 802.11s;
- signal, noise, bitrate и airtime подключённых Wi-Fi-клиентов;
- одинаковые Wi-Fi-возможности в Web UI и Android, capability report schema v7.
