...
Текущий prerelease: `v0.3.0-rc4`.

Главное в `0.3.0-rc4`:

- полностью перестроенный Android-интерфейс с понятной навигацией после выбора роутера;
- компактный список роутеров и обзор с прямым переходом в нужный рабочий раздел;
- структурированные экраны клиентов, Wi-Fi, интернета, системы и агента;
- раскрываемые редкие настройки и компактные действия вместо длинных форм;
