...
AGENT_INSTALL_PATH="${WRTMONITOR_AGENT_INSTALL_PATH:-/usr/bin/wrtmonitor-agent}"
INIT_INSTALL_PATH="${WRTMONITOR_INIT_INSTALL_PATH:-/etc/init.d/wrtmonitor}"
RELEASES_DIR="${WRTMONITOR_RELEASES_DIR:-$LIB_INSTALL_DIR/releases}"
