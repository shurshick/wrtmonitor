...
verify_config_integrity_for_command() {
    case "$1" in
        wifi.set_access_profile|wifi.set_schedule|maintenance.recovery.*) verify_uci_package wrtmonitor ;;
