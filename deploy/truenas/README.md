...
1. Скачайте из последнего релиза YAML с именем `wrtmonitor-truenas-v<версия>.yaml`.
...
Volume `wrtmonitor_backups` также не удаляйте: в нём хранятся проверенные резервные копии PostgreSQL. Управление копиями доступно на странице **Сервер** в Web UI.
