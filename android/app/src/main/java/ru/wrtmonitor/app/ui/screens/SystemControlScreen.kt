...
fun SystemControlScreen(
    ...
    RouterInformationCard(hostnameValue, hardware, systemSummary, connectionLabel)
    TemperatureSensorsCard(hardware, detailed = false)
    }
    if (mode == SystemScreenMode.Hardware) {
        HardwareIdentityCard(hardware)
        TemperatureSensorsCard(hardware, detailed = true)
    }
