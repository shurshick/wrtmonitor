...
@Composable
fun InfoRow(label: String, value: String?, fallback: String = "—", supporting: String? = null) {
    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp), verticalAlignment = Alignment.Top) {
        ...
        Column(Modifier.weight(1f)) {
            Text(value?.takeIf { it.isNotBlank() } ?: fallback, style = MaterialTheme.typography.bodyMedium, fontWeight = FontWeight.Normal, maxLines = 2, overflow = TextOverflow.Ellipsis)
